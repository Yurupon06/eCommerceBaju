...
@section('page-title', 'Discount Categorie')
      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <a href="{{route('discountcat.create')}}"><span class="badge badge-sm bg-gradient-primary mb-3 fs-6 ">add new item</span></a>
          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0" id="datatable">
                ...
                <tbody>
                  @foreach ($discountcat as $idx => $data)
                  ...
                  <tr>
                    ...
                    <td class="align-middle text-center text-sm">
                      <a href="{{route('discountcat.edit', $data->id)}}"><span class="badge badge-sm bg-gradient-success">edit</span></a>
                      <form action="{{ route('discountcat.destroy', $data->id) }}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
