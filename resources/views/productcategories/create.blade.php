            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <div class="card border-1 m-3 pt-3">
                  <form action="{{ route('productcategories.store')}}" id="formproductcategories" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="mb-3 ms-3 me-3">
                        <label for="category_name" class="form-label">Category Name</label>
                        <input type="text" class="ps-2 form-control border border-secondary-subtle" placeholder="Product Categories" aria-label="Name" id="category_name" name="category_name">
                      </div>
...
<!-- Close Tables -->
    ...
    <script>
      ...
      const form = document.getElementById("formproductcategories");
